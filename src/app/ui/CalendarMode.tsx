...
export default function CalendarMode() {
  ...
  // If the session reports a refresh error, force a fresh sign-in
  useEffect(() => {
    if ((session as any)?.error === "RefreshAccessTokenError") {
      // Prompt re-authentication to obtain a new refresh token
  ...
  const onDragEnd = (result: any) => {
    ...
    const tasksInSourceStatus = tasks.filter(
    ...
    const tasksInDestStatus = updatedTasks.filter(
        ...
        >
          ...
          {task.dueDate && (
            <div
              ...
              style={{ color: task.foregroundColor || "#FFFFFF" }}
            >
  ...
  if (!session) {
    return (
      <div className={styles.auth}>
        ...
        <p>
          To view and manage your calendar events as tasks, please connect your
